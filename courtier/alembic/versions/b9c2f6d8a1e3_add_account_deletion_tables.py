...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "requested_by", sa.String(16), nullable=False, comment='发起方："self" | "admin"'
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "trigger", sa.String(16), nullable=False, comment='触发方式："self_approved" | "admin"'
        ),
