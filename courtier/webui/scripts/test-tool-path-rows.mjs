...
// 半行校验
assert.equal(toolPathRowError({ tool: "t", paths: "", exempt: false }), "需要至少一个路径，或勾选豁免");
assert.equal(toolPathRowError({ tool: "", paths: "/x", exempt: false }), "缺少工具名");
assert.equal(toolPathRowError({ tool: "t", paths: "/x", exempt: true }), "");
