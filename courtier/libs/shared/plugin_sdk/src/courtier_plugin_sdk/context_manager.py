...
class PluginContextManager:
    ...
    async def persist_large_output(self, tool_name: str, data: Any, force: bool = False) -> Any:
    ...
    async def micro_compact(self, messages: list[dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    async def compact_if_needed(self, messages: list[dict[str, Any]]) -> list[dict[str, Any]]:
