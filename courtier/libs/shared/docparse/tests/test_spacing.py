...
class TestComputeAlignment:
    ...
    def test_body_text_returns_justify(self) -> None:
        ...
        assert (
            compute_alignment_from_position(50, 350, 500, outline_level="body_text")
            == "justify"
        )
    ...
    def test_others_wide_returns_justify(self) -> None:
        ...
        assert (
            compute_alignment_from_position(50, 350, 500, outline_level="others")
            == "justify"
        )
    ...
    def test_heading_wide_not_justify(self) -> None:
        ...
        assert (
            compute_alignment_from_position(50, 350, 500, outline_level="heading1")
            == "center"
        )
    ...
    def test_body_text_narrow_left(self) -> None:
        ...
        assert (
            compute_alignment_from_position(20, 100, 500, outline_level="body_text")
            == "left"
        )
...
class TestComputeParagraphSpacing:
    ...
    def test_single_line(self) -> None:
        """Single line returns zero spacing."""
        boxes = [[20, 100, 500, 120]]
        spacing = compute_paragraph_spacing(boxes, 943, 841.89)
        assert len(spacing) == 1
        info = spacing[0]
        assert info["space_before"] == 0.0
        assert info["space_after"] == 0.0
        assert info["line_spacing"] == 0.0
    ...
    def test_real_paragraph_break_detected(self) -> None:
        ...
        # Line after gap (index 3) should have space_before == 0
        # (only space_after is used; space_before is always 0 to avoid double-counting)
        assert spacing[3]["space_before"] == 0.0
