...
一个域无关的 AI Agent 平台：核心引擎只提供 Agent 运行时、工具编排、插件系统与技能框架，不包含任何业务知识；领域能力以自包含「域包」形式插入。首个官方域包 **docaudit** 提供基于 GB/T 9704-2012 的中文公文智能审计——**为党政机关内网环境设计，安全是第一设计目标**。

> 配套文档：[《系统架构设计文档》](智能公文审计平台系统架构设计文档.docx)、[面向 AI 代理的仓库说明](AGENTS.md)、[分轮审查报告与设计方案](docs/reviews/)
