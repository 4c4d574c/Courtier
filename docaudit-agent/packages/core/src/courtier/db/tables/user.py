...
class UserCreate(BaseModel):
    ...
    password: str = Field(..., min_length=8, max_length=128, description="密码（明文，服务端哈希后存储）")
...
class UserUpdate(BaseModel):
    ...
    password: str | None = Field(default=None, min_length=8, max_length=128, description="新密码（设置后覆盖原密码）")
