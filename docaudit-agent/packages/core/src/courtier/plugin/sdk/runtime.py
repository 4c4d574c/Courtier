...
class PluginRuntime:
    ...
    async def run(self) -> None:
        ...
        if self._pending_tasks:
            logger.debug(
                "Waiting for %d pending task(s) to finish...", len(self._pending_tasks)
            )
    ...
    async def _process_line(self, line: str) -> None:
        ...
        if "id" in msg and "method" not in msg:
            ...
            if (
                ...
                and msg_id < 0
                and self._host_service_client is not None
            ):
        ...
        if "method" in msg and "id" not in msg:
            ...
            logger.info(
                "DISPATCH_DONE req=%d method=%s", msg["id"], msg.get("method", "?")
            )
    ...
    def _handle_notification(self, msg: dict) -> None:
        ...
        if method == METHOD_SHUTDOWN:
            ...
            if (
                ...
                self._host_service_client = HostServiceClient(
